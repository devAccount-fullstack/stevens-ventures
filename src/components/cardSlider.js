...
export function renderCardSlider() {
  ...
  const jobSlides = jobs.map(job => {
    const websiteBtn = job.websiteLink ? `
  ...
  return `
    <section class="careers">
      ...
      <!-- View More button temporarily disabled until destination page exists -->
     <!--
      <div class="button-group-wrapper">
        <a class="btn transparent icon" href="/resources/">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path d="M8 15L11 12L8 9M13 15L16 12L13 9M12 22C6.47715 22 2 17.5228 2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22Z"
